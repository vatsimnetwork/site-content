...
1. Be clearly listed on the local facility's website, detailing the member's name, VATSIM ID and the position(s) that they are validated on, and
1. Have a maximum period of validity of 30 days, and
1. Be subject to regular review, and
1. Not be renewed/extended unless the candidate has made good use of the facility and has shown improvement over the period of validity of the solo endorsement, and
1. Renewable for a total period of up to 90 days, with each renewal only to have a maximum period of validity of 30 days
...
1. Be clearly listed on the local facility's website, detailing the member's name, VATSIM ID and the position that they are validated on, and
1. Have a maximum period of validity of 30 days, and
1. Be subject to regular review, and
1. Not be renewed/extended unless the candidate has made good use of the facility and has shown improvement over the period of validity of the solo endorsement, and
1. Renewable for a total period of up to 90 days, with each renewal only to have a maximum period of validity of 30 days
...
1. While procedural towers in the real world provide a non-radar approach service, VATSIM ATC environment allows for complete radar service.
...
1. To achieve adequate radar coverage, the Controller may utilize multiple visibility points in their Controller client.
...
1. Center airspace requiring special control procedures and knowledge such as Oceanic centers.

1. Center airspace consisting of very complex airspace, high traffic volume, or airspace 
...
* **7.1** In certain large remote areas with low air traffic volumes the EC may approve the creation of Overland FSS airspace
in order to enhance ATC coverage. There is no provision to create Overland FSS airspace in an area where there is considerably 
more than light traffic. In all cases of Overland FSS airspace, the following shall apply:
...
1. Demonstrates an understanding of the ATS role
1. Displays service delivery awareness
1. Displays situational awareness
1. Manages communication priority
1. Uses correct phraseology
1. Manages Flight Strips, Tags and Flight Plans
1. Displays professional behaviour and pleasant attitude
...
1. Applies basic altimetry
1. Issues appropriate clearance and departure instructions

* **D) GROUND OPERATIONS**
1. Issues appropriate GND instructions where/when required
1. Correctly transfers aircraft to TWR where required

* **E) TOWER OPERATIONS**
1. Selects suitable Duty/Active Runway
1. Generates ATIS
1. Issues appropriate TWR instructions where/when required
1. Issues takeoff clearances
1. Issues landing clearances
1. Applies correct runway separation
1. Handles missed approaches
1. Manages circuit traffic
1. Correctly transfers aircraft to next ATC unit.
...
1. Cancels STAR (if applicable) and provides tracking information for sequencing or separation
1. Issues descent and provides runway assignment or reiteration
1. Correctly positions aircraft for approach type
1. Correctly issues the approach clearance
1. Provides suitable tracking instructions (radar vectors or with reference to NAVAIDS) to aircraft when required.
1. Initiates holding when necessary to regulate traffic flow
1. Adjusts aircraft speed or track to achieve sequence
1. Applies appropriate vertical separation between aircraft
1. Applies appropriate lateral separation between aircraft
...
1. Cancels SID and vectors aircraft for sequencing or separation
1. Issues amended ‘maintain’ level where necessary for positive separation
1. Correctly transfers aircraft to the Enroute controller

* **D) ARRIVALS**
1. Ensures pilot is in receipt of correct ATIS information
1. Cancels STAR and vectors aircraft for sequencing or separation
1. Issues descent and provides runway assignment or reiteration
1. Provides position and distance to run to aircraft
1. Correctly positions aircraft for approach type
1. Correctly issues the approach clearance
1. Correctly transfers aircraft to the TWR controller

* **E) TRAFFIC MANAGEMENT**
1. Verifies mode C level of aircraft when commencing radar service
1. Issues appropriate TMA instructions where/when required
1. Provides suitable vectors to aircraft when required
1. Initiates holding when necessary to regulate traffic flow
1. Adjusts aircraft speed or track to achieve sequence
...
1. Provides additional information or navigation service
1. Correctly processes aircraft entering CTA from Class G airspace
1. Correctly processes aircraft leaving CTA into Class G airspace
1. Implements flight following procedures when requested

### IV) ENROUTE Controller (C1) – CTR positions

* **A) GENERAL**
1. Setup, Configure and Connect to the network
1. Demonstrates understanding of the ATS role
1. Displays service delivery awareness
1. Displays situational awareness
1. Manages communication priority
1. Uses correct phraseology
...
1. Applies advanced altimetry concepts
1. Provides suitable vectors to aircraft when required
1. Initiates holding when necessary to regulate traffic flow
1. Adjusts aircraft speed or track to achieve initial sequencing for arrival
1. Correctly transfers aircraft to next ATC unit

* **D) SEPARATION**
1. Provides separation service appropriate for class of airspace
1. Applies appropriate vertical separation between aircraft
1. Applies appropriate vertical separation to aircraft operating in the RVSM band
1. Applies time separation between aircraft in a non-radar environment
1. Applies separation between aircraft in a radar environment
1. Pre-emptively applies separation assurance to avoid rather than resolve conflicts

* **E) AIRSPACE SERVICES**
1. Provides traffic services appropriate for the class of airspace
1. Provides additional information or navigation service
1. Issues airways clearance to aircraft entering CTA
1. Terminates services for aircraft leaving CTA
1. Issues STAR Clearance where necessary
1. Provides services appropriate to VFR aircraft
...
1. AFR_N_FSS - North Africa Centre
1. GULF_FSS - Persian Gulf Centre
...
1. ASIA_W_FSS - Asia West Centre
1. PRC FSS - Beijing Control
...
1. EGGX_FSS - Shanwick Radio (Oceanic)
1. ENOB_FSS - Bodo Radio (Oceanic)
1. EURM_CTR - Eurocontrol Maastricht Radar (above FL245)
1. LON_CTR - London Centre
1. LPPO_FSS - Santa Maria Radio (Oceanic)
1. UKR_CTR - Ukraine Centre

*Approved Overland FSS*
1. EURE_FSS - Eurocontrol East Radar (above FL245)
1. EURI_FSS - Eurocontrol Islands Radar (above FL245)
1. EURN_FSS - Eurocontrol North Radar (above FL245)
1. EURS_FSS - Eurocontrol South Radar (above FL245)
1. EURW_FSS - Eurocontrol West Radar (above FL245)
1. RU-CEN_FSS - Central Asia Control
1. RU-ERC_FSS - Eastern Russia Control
1. RU-ESC_FSS - Eastern Siberia Control
1. RU-NWC_FSS - North Western Russia Control
1. RU-WRC_FSS - Western Russia Control
1. RU-WSC_FSS - Western Siberia Control
...
1. ZAK_FSS - San Francisco Radio (Oceanic)
1. MIA_O_CTR - Miami Radio (Oceanic)
1. NY_JBC_FSS - New York Radio (Oceanic)
1. ZAN_FSS - Anchorage Radio (Oceanic)
1. ZHU_79_FSS - Houston Radio (Oceanic)
1. CZEG_FSS - Edmonton Radio (Domestic)
1. MMZT_FSS - Mazatlan Oceanic FIR
...
1. ML-IND_FSS - Melbourne Radio (Oceanic)
1. NFFF_FSS - Nadi Radio (Oceanic)
1. NTTT_FSS - Tahiti Control (Oceanic)
1. NZCM_FSS - McMurdo Radio (Oceanic)
1. NZZO_FSS - Auckland Radio (Oceanic)
1. ML-INE_FSS - Melbourne Radio (Indian East)
1. ML-INS_FSS - Melbourne Radio (Indian South)
1. BN-HWE_FSS - Brisbane Radio (Howe)
1. BN-FLD_FSS - Brisbane Radio (Flinders)
1. BN-COL_FSS - Brisbane Radio (Coral)
